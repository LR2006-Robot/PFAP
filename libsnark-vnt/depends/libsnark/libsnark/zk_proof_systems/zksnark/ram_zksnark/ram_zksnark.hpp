...
#include <libsnark/zk_proof_systems/zksnark/ram_zksnark/ram_compliance_predicate.hpp>
...
#include <libsnark/zk_proof_systems/zksnark/ram_zksnark/ram_zksnark.tcc>
