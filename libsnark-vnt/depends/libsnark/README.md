...
- libproc2 for reporting memory usage
...
* On Ubuntu 16.04 LTS:
        ...
        $ sudo apt-get install build-essential cmake git libgmp3-dev libproc2-dev python-markdown libboost-all-dev libssl-dev
...
*   `cmake -DWITH_PROCPS=OFF`
    ...
    Do not link against libproc2. This disables memory profiling.
