...
bool verifyMintproof(char *data, char *sn_old_string, char *rt_string, char *cmtA_string, uint64_t value_s)
{
    uint256 sn_old = uint256S(sn_old_string);
...
r1cs_gg_ppzksnark_keypair<alt_bn128_pp> keypair;
    ...
    bool result = verify_mint_proof(keypair.vk, proof, sn_old, rt, cmtA, value_s);
