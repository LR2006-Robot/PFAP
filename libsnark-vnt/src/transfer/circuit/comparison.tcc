...
public:
    ...
    void generate_r1cs_constraints()
    {
        ...
        not_all_zeros = \bigvee_{i=0}^{n-1} alpha_i   (logical OR)
        ...
        */
        ...
        /*********************************************************************************
         * Initially we set less_or_eq = 0, i.e. alpha_n = 0.
         * less_or_eq * not_all_zeros = less
         * 0 * not_all_zeros = 0 => less => A < B
         * 0 * not_all_zeros = 1 => eq   => A = B
         * 1 * not_all_zeros = 1 => less_or_eq => A < B  (correct)
         * 1 * not_all_zeros = 0 => nothing
         * 1 * not_all_zeros = not_all_zeros => less_or_eq => A <= B  (correct)
         * 0 * not_all_zeros = not_all_zeros => eq => A = B
         * Since this->pb.val(0) == this->pb.val(1), the constraint holds when not_all_zeros = 1.
         * ********************************************************************************/
