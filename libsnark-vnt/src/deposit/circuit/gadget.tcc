...
public:
    ...
    deposit_gadget(
        ...
        prf_to_inputs_sn.reset(new sha256_PRF_gadget<FieldT>( 
            ...
            sn_old->bits,    // 256bits old serial number
        ...
        prf_to_inputs_sn_s.reset(new sha256_PRF_gadget<FieldT>( 
            ...
            ZERO,
            sk->bits,             // 256bits private key
            zero_for_prf->bits,   // 256bits zero
    ...
    void generate_r1cs_witness(
        ...
        // Fill PRF inputs and outputs FIRST, then call witness generation
        zero_for_prf->bits.fill_with_bits(
            this->pb,
            std::vector<bool>(256, false)
        );
